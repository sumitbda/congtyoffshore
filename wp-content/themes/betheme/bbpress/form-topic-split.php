                    ...
                    <div>
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <input type="text" id="bbp_topic_split_destination_title"
                                       value="<?php printf(__('Split: %s', 'bbpress'), bbp_get_topic_title()); ?>"
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <?php if (bbp_is_subscriptions_active()) : ?>
                                    ...
                                    <label for="bbp_topic_subscribers"><?php _e('Copy subscribers to the new topic', 'bbpress'); ?></label>
                                    <br/>
                                ...
                                <?php if (bbp_allow_topic_tags()) : ?>
                                    ...
                                    <input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1"
                                           checked="checked" tabindex="<?php bbp_tab_index(); ?>"/>
                                    <label for="bbp_topic_tags"><?php _e('Copy topic tags to the new topic', 'bbpress'); ?></label>
                                    <br/>
                        ...
                        <div class="bbp-submit-wrapper">
                            <button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_merge_topic_submit"
                                    ...
                                    class="button submit"><?php _e('Submit', 'bbpress'); ?></button>
                        </div>
                    </div>
