                ...
                <form id="rename_tag" name="rename_tag" method="post" action="<?php the_permalink(); ?>">
                    ...
                    <div class="bbp-submit-wrapper">
                        <button type="submit" tabindex="<?php bbp_tab_index(); ?>"
                                class="button submit"><?php esc_attr_e('Update', 'bbpress'); ?></button>
            ...
            <fieldset class="bbp-form" id="tag-merge">
                ...
                <form id="merge_tag" name="merge_tag" method="post" action="<?php the_permalink(); ?>">
                    ...
                    <div>
                        ...
                        <input type="text" id="tag-existing-name" name="tag-existing-name" size="22"
                               tabindex="<?php bbp_tab_index(); ?>" maxlength="40"/>
                    </div>

                    <div class="bbp-submit-wrapper">
                        <button type="submit" tabindex="<?php bbp_tab_index(); ?>" class="button submit"
                                onclick="return confirm('<?php echo esc_js(sprintf(__('Are you sure you want to merge the "%s" tag into the tag you specified?', 'bbpress'), bbp_get_topic_tag_name())); ?>');"><?php esc_attr_e('Merge', 'bbpress'); ?></button>
            ...
            <?php if (current_user_can('delete_topic_tags')) : ?>
                ...
                <fieldset class="bbp-form" id="delete-tag">
                    ...
                    <form id="delete_tag" name="delete_tag" method="post" action="<?php the_permalink(); ?>">
                        ...
                        <div class="bbp-submit-wrapper">
                            <button type="submit" tabindex="<?php bbp_tab_index(); ?>" class="button submit"
                                    onclick="return confirm('<?php echo esc_js(sprintf(__('Are you sure you want to delete the "%s" tag? This is permanent and cannot be undone.', 'bbpress'), bbp_get_topic_tag_name())); ?>');"><?php esc_attr_e('Delete', 'bbpress'); ?></button>
